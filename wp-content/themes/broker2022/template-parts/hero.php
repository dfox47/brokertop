...
<div class="hero_block_slider">
	<div class="cs3-wrap">
		<div class="cs3 js-hero-slider">
			<div class="cs3-slide">
				<div class="hero_block_slide"><img class="hero_block_slide__img" src="<?php echo $i; ?>/17.jpg" alt="" /></div>
			</div>

			<div class="cs3-slide">
				<div class="hero_block_slide"><img class="hero_block_slide__img" src="<?php echo $i; ?>/8.jpg" alt="" /></div>
			</div>

			<div class="cs3-slide">
				<div class="hero_block_slide"><img class="hero_block_slide__img" src="<?php echo $i; ?>/3.jpg" alt="" /></div>
			</div>

			<div class="cs3-slide">
				<div class="hero_block_slide"><img class="hero_block_slide__img" src="<?php echo $i; ?>/18.jpg" alt="" /></div>
			</div>

			<div class="cs3-slide">
				<div class="hero_block_slide"><img class="hero_block_slide__img" src="<?php echo $i; ?>/1.jpg" alt="" /></div>
			</div>
