...
/* Обновление из API (кнопка в товарах) */
jQuery(document).ready(function($) {
	$("#import_estate_api").click(function(){
		alert('Импорт объектов начался, приблизительное время ожидания 30 минут');
		
		$.ajax({
			url: '/import_estate_api.php',
