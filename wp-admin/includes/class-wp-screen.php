...
final class WP_Screen {
	 ...
	 *
	 * This is called in admin-head.php after the menu parent for the screen has been determined.
	 *
	 * @since 3.3.0
	 *
	 ...
	 *
	 * Call this in template files after admin.php is loaded and before admin-head.php is loaded
